...
def run():
    with sync_playwright() as p:
        ...
        # Start server in background first (assumed running)
        try:
            ...
            assert page.locator("text=Gemini 3 Pro").is_visible()
            assert page.locator("text=Veo 3.1").is_visible()
            assert page.locator("text=Jules").is_visible()
