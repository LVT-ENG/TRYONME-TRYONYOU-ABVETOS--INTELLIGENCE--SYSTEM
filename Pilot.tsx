...
const Pilot = () => {
  ...
  const handleFindFit = () => {
    ...
    setTimeout(() => {
      ...
      localStorage.setItem(
        "userMeasurements",
        JSON.stringify(userMeasurements),
      );
      setLocation("/result");
    }, 1500);
  };
  ...
  const measurementFields = [
    ...
    {
      key: "shoulder_width",
      label: t("pilot.labels.shoulder_width"),
      placeholder: "42",
    },
    {
      key: "arm_length",
      label: t("pilot.labels.arm_length"),
      placeholder: "62",
    },
    {
      key: "leg_length",
      label: t("pilot.labels.leg_length"),
      placeholder: "84",
    },
    {
      key: "torso_length",
      label: t("pilot.labels.torso_length"),
      placeholder: "66",
    },
  ];
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            <div className="bg-gray-50 rounded-xl p-8 border border-gray-200">
              ...
              <p className="text-gray-700 mb-8">{t("pilot.description")}</p>
                    ...
                    >
                      ...
                      <SelectContent>
                        <SelectItem value="work">
                          {t("pilot.occasions.work")}
                        </SelectItem>
                        <SelectItem value="casual">
                          {t("pilot.occasions.casual")}
                        </SelectItem>
                        <SelectItem value="formal">
                          {t("pilot.occasions.formal")}
                        </SelectItem>
                        <SelectItem value="event">
                          {t("pilot.occasions.event")}
                        </SelectItem>
                        <SelectItem value="ceremony">
                          {t("pilot.occasions.ceremony")}
                        </SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
