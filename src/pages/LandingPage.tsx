...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#141619] text-[#F0F0F0] font-sans overflow-x-hidden">
      ...
      <header className="fixed top-0 left-0 w-full z-50 px-8 py-6 flex justify-between items-center bg-gradient-to-b from-[#141619] to-transparent">
      ...
      <section className="relative h-screen w-full flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mt-20">
          <h1 className="text-5xl md:text-7xl font-serif text-white mb-6 tracking-wide drop-shadow-2xl">
            {t('hero_title_prefix')} <br/> <span className="text-[#C5A46D] italic">{t('hero_title_highlight')}</span>
          </h1>
      ...
      <section className="py-24 bg-[#0f1113]">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
          <div className="space-y-4 p-8 border border-white/5 hover:border-[#C5A46D]/30 transition-colors duration-500">
            ...
            <h3 className="text-xl font-serif text-white">{t('claim_confidence_title')}</h3>
            <p className="text-gray-400 text-sm leading-relaxed">
              {t('claim_confidence_desc')}
            </p>
          </div>
          <div className="space-y-4 p-8 border border-white/5 hover:border-[#C5A46D]/30 transition-colors duration-500">
            <div className="text-[#C5A46D] text-4xl mb-4">⏳</div>
            <h3 className="text-xl font-serif text-white">{t('claim_time_title')}</h3>
            <p className="text-gray-400 text-sm leading-relaxed">
              {t('claim_time_desc')}
            </p>
          </div>
          <div className="space-y-4 p-8 border border-white/5 hover:border-[#C5A46D]/30 transition-colors duration-500">
            <div className="text-[#C5A46D] text-4xl mb-4">🎯</div>
            <h3 className="text-xl font-serif text-white">{t('claim_precision_title')}</h3>
            <p className="text-gray-400 text-sm leading-relaxed">
              {t('claim_precision_desc')}
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-[#141619] relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 text-center relative z-10">
          <h2 className="text-3xl text-[#C5A46D] mb-4 tracking-wider">{t('powered_by')}</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 items-center justify-items-center opacity-80">
            ...
            <div className="flex flex-col items-center space-y-4">
              ...
              <p className="text-gray-500 text-xs uppercase tracking-widest">{t('real_time_narrative')}</p>
            </div>
            ...
            <div className="flex flex-col items-center space-y-4 transform scale-110">
              ...
              <p className="text-gray-500 text-xs uppercase tracking-widest">{t('style_intelligence')}</p>
            </div>
            ...
            <div className="flex flex-col items-center space-y-4">
              ...
              <p className="text-gray-500 text-xs uppercase tracking-widest">{t('on_device_privacy')}</p>
            </div>
          </div>
        </div>
