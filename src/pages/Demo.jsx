...
const AvatarSVG = React.memo(({ selectedTop, selectedBottom }) => {
  const renderTop = () => {
    switch (selectedTop) {
      case 'blazer':
        return (
...
const Demo = () => {
  ...
  const selectedTopData = useMemo(() => tops.find(t => t.id === selectedTop), [selectedTop])
  const selectedBottomData = useMemo(() => bottoms.find(b => b.id === selectedBottom), [selectedBottom])
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="flex flex-col items-center">
              <div className="relative w-full max-w-md aspect-[3/4] bg-gradient-to-b from-slate-800 to-slate-900 rounded-2xl overflow-hidden border border-white/10">
                ...
                {/* Human Avatar */}
                <AvatarSVG selectedTop={selectedTop} selectedBottom={selectedBottom} />
