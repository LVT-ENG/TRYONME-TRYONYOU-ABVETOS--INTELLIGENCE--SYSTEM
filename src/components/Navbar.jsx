...
import { Menu, X, ShoppingBag, User, Shirt, Sparkles, Wand2, Home, Play, Ruler, Package, CreditCard, ShieldCheck, MessageCircle, Scan } from 'lucide-react'
...
const Navbar = () => {
  ...
  const navLinks = [
    ...
    { path: '/scan', label: 'PILOT SCAN', icon: Scan },
  ]
