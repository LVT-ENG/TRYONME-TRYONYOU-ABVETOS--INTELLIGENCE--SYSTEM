...
export default function PauAgent() {
  const [messages, setMessages] = useState([
    {
      role: "agent",
      text: "Bonjour. I am Pau, your personal style curator at Galeries Lafayette. How may I assist you with your wardrobe today?",
    },
  ]);
        ...
        <div className="flex justify-center mb-8">
          <div className="w-24 h-24 rounded-full overflow-hidden border-2 border-white/20 relative">
            <img
              ...
              onError={(e) => {
                e.currentTarget.src =
                  "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?q=80&w=1000&auto=format&fit=crop"; // Fallback
              }}
            />
          </div>
        </div>
