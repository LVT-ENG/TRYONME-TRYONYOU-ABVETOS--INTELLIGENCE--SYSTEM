            ...
            <div key={item.id} className="group relative">
              <div className="aspect-[3/4] overflow-hidden bg-neutral-900 rounded-sm border border-white/10 relative">
                ...
                <img 
                  ...
                  onError={(e) => {
                    e.currentTarget.src = "https://images.unsplash.com/photo-1539008835657-9e8e9680c956?q=80&w=1000&auto=format&fit=crop"; // Fallback
                  }}
                />
              ...
              <div className="mt-6 flex justify-between items-start">
                <div>
                  ...
                  <p className="text-sm text-neutral-400 uppercase tracking-wider mt-1">{item.brand}</p>
                </div>
